...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; }
        ...
        /* Hoprise visual system */
        :root{--ink:#1a1a1a;--muted:#6f6a63;--navy:#1a1a1a;--blue:#2fcb63;--sky:#e8f7ed;--line:#ddd2bf;--gold:#2fcb63}body{background-color:#eee4d2;background-image:linear-gradient(112deg,transparent 0 28%,rgba(117,98,70,.07) 30%,transparent 32%),linear-gradient(72deg,transparent 0 67%,rgba(255,255,255,.35) 69%,transparent 71%),radial-gradient(ellipse at 20% 8%,rgba(255,255,255,.45),transparent 36%),repeating-linear-gradient(0deg,transparent 0 31px,rgba(185,165,132,.25) 32px,transparent 33px);background-attachment:fixed;color:var(--ink);font-family:'Inter',sans-serif;font-weight:500}.brand,h1,h2,h3,.quote-card blockquote{font-family:'Inter',sans-serif;font-weight:800;letter-spacing:-.02em}.navbar{background:transparent}.nav-links a{position:relative;color:var(--muted);opacity:.7;transition:opacity .25s ease,color .25s ease}.nav-links a:hover{color:var(--ink);opacity:1}.nav-links a:after{content:'';position:absolute;bottom:-7px;left:0;width:0;height:2px;background:#2fcb63;transition:width .3s ease}.nav-links a:hover:after{width:100%}.btn{min-height:48px;border-radius:9999px;transition:250ms ease}.btn:hover{transform:scale(1.03)}.btn:active{transform:scale(.98)}.btn-primary{background:#2fcb63;box-shadow:0 10px 22px rgba(47,203,99,.22)}.btn-primary:hover{background:#27b457}.btn-ghost{border:1px solid #ddd2bf;background:#f8f4ec;color:#1a1a1a}.hero-shell{background:transparent;border-color:#ddd2bf}.hero:before,.hero:after{border-color:#ddd2bf}.eyebrow{color:#1e9147;background:#e8f7ed;border-color:#b0e8c3}.dashboard,.stats,.step,.quote-card,.float-card{background:#f8f4ec;border-color:#ddd2bf;box-shadow:0 10px 30px rgba(0,0,0,.05)}.profile-card,.suggestions,.quote-section{background:#e8f7ed}.tag,.step-num{background:#e8f7ed;color:#1e9147}.progress{background:#d8d2c8}.progress span{background:#2fcb63}.step{border-radius:24px;transition:300ms cubic-bezier(.22,1,.36,1)}.step:hover{transform:translateY(-6px);box-shadow:0 18px 38px rgba(0,0,0,.08)}.stats{border-radius:32px}.cta-box{background:#1a1a1a;border-radius:32px}.cta-box .btn{color:#1e9147}.hero-visual,.dashboard{overflow:hidden}.dashboard{border-radius:28px}.hero-visual:hover .dashboard{transform:rotate(1.3deg) scale(1.04);transition:transform 500ms ease}.section,.stats,.quote-section,.cta{animation:hoprise-reveal 700ms ease-out both}@keyframes hoprise-reveal{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}
        /* Keep floating dashboard details visible outside the illustration frame. */
        .hero-visual{overflow:visible}.dashboard{overflow:hidden}.hero-visual:hover .dashboard{transform:rotate(1.3deg) scale(1.04);transition:transform 500ms ease}
        /* Subtle paper fibre, without harsh crease lines */
        body{background-image:radial-gradient(ellipse at 18% 8%,rgba(255,255,255,.46),transparent 32%),radial-gradient(ellipse at 84% 82%,rgba(117,98,70,.06),transparent 38%),radial-gradient(ellipse at 52% 48%,transparent 40%,rgba(117,98,70,.035) 70%,transparent 78%),repeating-linear-gradient(90deg,transparent 0 10px,rgba(117,98,70,.018) 11px,transparent 12px),repeating-linear-gradient(0deg,transparent 0 31px,rgba(185,165,132,.20) 32px,transparent 33px)!important}
    </style>
</head>
<body>
